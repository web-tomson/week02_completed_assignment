...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Players with infinite turns (0 or negative) were not re-added to the queue.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Players with 0 turns were treated as having no turns instead of infinite turns.
    ...
    // Defect(s) Found: Players with negative turns were treated as having no turns instead of infinite turns.
    ...
    // Defect(s) Found: None after verifying exception handling.
